...
if __name__ == '__main__':
    ...
    parser.add_argument("--ith", type=int, default=28)
    parser.add_argument("--gap", type=int, default=1)
    parser.add_argument("--session", type=str, default='2024-07-01-02-action-instruments')
    parser.add_argument("--scan_path", type=str, default='instruments/ukelele_scan/ukelele-simplified.obj')
    parser.add_argument("--to_filter_views", action="store_true")
    parser.add_argument("--use_optim_params", action="store_true")
    parser.add_argument("--save_seg_video", action="store_true", default=True)
    parser.add_argument("--save_seg_frame", action="store_true", default=True)
    ...
    args.step2 = False # reconstruction for T
    ...
    if args.step2:
        ...
        for abs_idx, anchor_frame_id in enumerate(range(reader.frame_count)):
    ...
    if args.step3:
        ...
        for init_round in range(2):
            ...
            num_initializations = 5 if init_round == 1 else 5
